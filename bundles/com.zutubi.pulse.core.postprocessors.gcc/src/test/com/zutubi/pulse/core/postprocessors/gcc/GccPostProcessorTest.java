...
/**
 */
public class GccPostProcessorTest extends PostProcessorTestBase
{
    ...
    {
        createAndProcessArtifact("errors", pp);
        assertErrors("MkDir1 ../bin.v2/libs/tr1/test/tr1_has_tr1_result_of_fail.test/gcc-4.1.2/debug\n" +
    ...
    {
        createAndProcessArtifact("warnings", pp);
        assertWarnings("                 from /home/jsankey/archives/boost_1_34_1/boost/tr1/tr1/strstream:18,\n" +
