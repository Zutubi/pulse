...
public class PerforceWorkingCopyTest extends PerforceTestBase
{
    ...
    private void createClients() throws ScmException
    {
        ...
        core.createOrUpdateWorkspace("client-1", CLIENT_NAME, "description", clientRoot.getAbsolutePath(), null, null, null);
        ...
        otherCore.createOrUpdateWorkspace("client-1", OTHER_CLIENT_NAME, "description", otherClientRoot.getAbsolutePath(), null, null, null);
