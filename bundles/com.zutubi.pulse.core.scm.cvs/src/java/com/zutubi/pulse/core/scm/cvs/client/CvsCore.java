...
public class CvsCore
{
    ...
    public String version() throws ScmException
    {
        ...
        // unexpected format for the version.
        throw new ScmException("Unexpected server version: '" + version.getVersion() + "'");
    }
    ...
    public void update(File workingDirectory, CvsRevision revision, CVSListener listener) throws ScmException
    {
        ...
        if (revision != null)
        {
            if (TextUtils.stringSet(revision.getBranch()) && revision.getDate() != null)
            {
                ...
                String rev = revision.getBranch() + ":" + DATE_FORMAT.format(revision.getDate());
            ...
            {
                update.setUpdateByDate(DATE_FORMAT.format(revision.getDate()));
            }
        }
    ...
    public void checkout(File workdir, String module, CvsRevision revision, boolean recursive, ScmFeedbackHandler handler) throws ScmException
    {
        ...
        if (revision != null)
        {
            ...
            {
                checkout.setCheckoutByDate(DATE_FORMAT.format(revision.getDate()));
            }
        }
    ...
    public void tag(String module, CvsRevision revision, String name, boolean moveExisting) throws ScmException
    {
        ...
        if (revision != null)
        {
            ...
            if (revision.getDate() != null)
            {
                tag.setTagByDate(DATE_FORMAT.format(revision.getDate()));
            }
        }
        else
        {
    ...
    public List<LogInformation> rlog(String module, CvsRevision from, CvsRevision to, boolean verbose) throws ScmException
    {
        ...
        {
            dateFilter = DATE_FORMAT.format(from.getDate()) + del;
            del = "";
        }
        if (to != null && to.getDate() != null)
        {
            dateFilter = dateFilter + del + DATE_FORMAT.format(to.getDate());
        }
