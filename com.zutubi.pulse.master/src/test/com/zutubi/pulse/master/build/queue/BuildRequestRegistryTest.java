...
public class BuildRequestRegistryTest extends PulseTestCase
{
    ...
    private void assertKnown(BuildRequestEvent... requests)
    {
        for (BuildRequestEvent abe: requests)
        {
            assertTrue(buildRequestRegistry.getStatus(abe.getId()) != BuildRequestRegistry.RequestStatus.UNKNOWN);
        }
    }

    private void assertUnknown(BuildRequestEvent... requests)
    {
        for (BuildRequestEvent abe: requests)
        {
    ...
    private BuildRequestEvent createEvent()
    {
        ...
        return new SingleBuildRequestEvent(this, project, null, new TriggerOptions(null, "source"));
    }
}
