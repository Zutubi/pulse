...
public class ChangedByMeSinceSuccessNotificationConditionTest extends PulseTestCase
{
    ...
    protected void setUp() throws Exception
    {
        ...
        }).when(buildManager).executeInTransaction((Runnable) anyObject());
    ...
    {
        stub(buildManager.getChangesForBuild(build)).toReturn(CollectionUtils.map(authors, new Mapping<UserConfiguration, PersistentChangelist>()
        {
