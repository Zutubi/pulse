 ...
 */
public class ActionFormDirective extends ToveDirective
{
    ...
    public boolean render(InternalContextAdapter contextAdapter, Writer writer, Node node) throws IOException, ResourceNotFoundException, ParseErrorException
    {
        try
        {
            ...
            Map<String, Object> context = ToveUtils.initialiseContext(argumentType.getClazz());
            ...
            try
            {
                Template template = configuration.getTemplate("tove/xhtml/form.ftl");
