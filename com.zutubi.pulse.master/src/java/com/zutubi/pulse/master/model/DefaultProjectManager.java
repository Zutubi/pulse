...
public class DefaultProjectManager implements ProjectManager, ExternalStateManager<ProjectConfiguration>, ConfigurationInjector.ConfigurationSetter<Project>, EventListener
{
    ...
    {
        Set<ProjectConfiguration> projectConfigs = configurationProvider.getAllDescendents(PathUtils.getPath(ConfigurationRegistry.PROJECTS_SCOPE, project), ProjectConfiguration.class, strict, true);
    ...
    {
        return isCompleteAndValid(project, false);
    }
