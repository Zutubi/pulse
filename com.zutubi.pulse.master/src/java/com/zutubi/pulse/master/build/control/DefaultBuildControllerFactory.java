...
public class DefaultBuildControllerFactory implements BuildControllerFactory
{
    ...
    public void init()
    {
        ...
        try
        {
            JobDetail detail = quartzScheduler.getJobDetail(DefaultBuildController.TIMEOUT_JOB_NAME, DefaultBuildController.TIMEOUT_JOB_GROUP);
            if (detail ==  null)
            {
                detail = new JobDetail(DefaultBuildController.TIMEOUT_JOB_NAME, DefaultBuildController.TIMEOUT_JOB_GROUP, TimeoutRecipeJob.class);
