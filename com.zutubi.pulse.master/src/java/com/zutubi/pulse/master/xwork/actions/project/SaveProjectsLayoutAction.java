...
public class SaveProjectsLayoutAction extends ActionSupport
{
    ...
    {
        ProjectConfiguration projectConfig = configurationProvider.get(PathUtils.getPath(ConfigurationRegistry.PROJECTS_SCOPE, template), ProjectConfiguration.class);
