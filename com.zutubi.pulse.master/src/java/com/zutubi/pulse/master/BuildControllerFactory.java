...
import static com.zutubi.pulse.master.BuildController.TIMEOUT_JOB_GROUP;
import static com.zutubi.pulse.master.BuildController.TIMEOUT_JOB_NAME;
...
{
    private static final Logger LOG = Logger.getLogger(BuildControllerFactory.class);
