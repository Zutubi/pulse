...
YAHOO.extend(ZUTUBI.widget.FileNode, YAHOO.widget.TextNode, {
    ...
    getNodeHtml: function()
    {
        ...
        {
            sb[sb.length] = '<td class="' + this.getDepthStyle(i) + '"><img width="17" height="22" src="' + this.tree.base + '/images/transparent.gif"/></td>';
        }
        ...
        sb[sb.length] = '<img width="17" height="22" src="' + this.tree.base + '/images/transparent.gif"/>';
        ...
        sb[sb.length] = '><img width="16" height="22" src="' + this.tree.base + '/images/transparent.gif"/>';
        sb[sb.length] = '</td>';
