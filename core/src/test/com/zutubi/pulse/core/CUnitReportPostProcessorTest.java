...
/**
 */
public class CUnitReportPostProcessorTest extends XMLReportPostProcessorTestBase
{
    ...
    public CUnitReportPostProcessorTest(String name)
    {
        super(name, new CUnitReportPostProcessor());
    }

    public void setUp() throws IOException
    {
        pp = new CUnitReportPostProcessor();
    }
