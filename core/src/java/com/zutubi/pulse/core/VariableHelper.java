...
public class VariableHelper
{
    ...
    public static String replaceVariables(String input, Scope properties, ResolutionStrategy resolutionStrategy) throws FileLoadException
    {
    ...
    public static List<String> splitAndReplaceVariables(String input, Scope properties, ResolutionStrategy resolutionStrategy) throws FileLoadException
    {
    ...
    private static String resolveReference(Scope properties, Token token, ResolutionStrategy resolutionStrategy) throws FileLoadException
    {
