...
public class Changelist extends Entity
{
    ...
    public String getHash()
    {
        ...
        {
            // Calculate on demand.
            String input = safeString(Long.toString(safeTime(revision.getDate())) + "/" + revision.getAuthor() + "/" + safeString(revision.getBranch()) + "/" + safeString(revision.getComment()) + "/" + safeString(revision.getRevisionString()));
