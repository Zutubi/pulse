...
exec "$JAVACMD" -classpath "$LOCALCLASSPATH" -Dbob.install="$BOB_HOME" -Djava.util.logging.config.class=com.cinnamonbob.logging.ConsoleConfig -Djava.awt.headless=true $@
