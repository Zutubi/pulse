...
public class ConfigurationTemplateManagerTest extends AbstractConfigurationSystemTestCase
{
    ...
    public void testGetAncestorOfType_Self()
    {
        ...
        Configuration loaded = configurationTemplateManager.getInstance(PathUtils.getPath(SCOPE_SAMPLE, "a"));
    ...
    public void testGetAncestorOfType_Parent()
    {
        ...
        Configuration loaded = configurationTemplateManager.getInstance(PathUtils.getPath(SCOPE_SAMPLE, "a", "composite"));
        ConfigA ancestor = configurationTemplateManager.getAncestorOfType(loaded, ConfigA.class);
        assertEquals(configurationTemplateManager.getInstance(PathUtils.getPath(SCOPE_SAMPLE, "a")), ancestor);
    }
    ...
    public void testGetAncestorOfType_GrandParent()
    {
        ...
        Configuration loaded = configurationTemplateManager.getInstance(PathUtils.getPath(SCOPE_SAMPLE, "a", "cs", "cee"));
        ConfigA ancestor = configurationTemplateManager.getAncestorOfType(loaded, ConfigA.class);
        assertEquals(configurationTemplateManager.getInstance(PathUtils.getPath(SCOPE_SAMPLE, "a")), ancestor);
    }
