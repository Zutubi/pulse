...
public class CloneAcceptanceTest extends SeleniumTestBase
{
    ...
    {
        // CIB-2673
        String childPath = xmlRpcHelper.insertSimpleProject(random, false);
        ...
        xmlRpcHelper.insertConfig(childTriggersPath, trigger);
        ...
        triggersPage = browser.openAndWaitFor(ListPage.class, getPath(MasterConfigurationRegistry.PROJECTS_SCOPE, random + CLONE_PROPERTY_NAME, "triggers"));
        assertEquals("scheduled", triggersPage.getCellContent(0, 2));
        triggersPage = browser.openAndWaitFor(ListPage.class, getPath(MasterConfigurationRegistry.PROJECTS_SCOPE, random + PARENT_PROPERTY_NAME, "triggers"));
