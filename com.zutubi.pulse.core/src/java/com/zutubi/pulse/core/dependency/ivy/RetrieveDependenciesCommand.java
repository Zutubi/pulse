...
public class RetrieveDependenciesCommand implements Command
{
    ...
    public void execute(final CommandContext commandContext)
    {
        try
        {
            ...
            AuthenticatedAction.execute(host, context.getSecurityHash(), new Callable<Object>()
            {
                ...
                {
                    Future<Object> future = Executors.newSingleThreadExecutor().submit(new Retriever(commandContext));
                    return future.get();
                }
            });
        }
    ...
    {
        Thread thread = this.retrieveThread;
        if (thread != null)
        {
    ...
    private class Retriever implements Callable<Object>
    {
        private final CommandContext commandContext;

        public Retriever(CommandContext commandContext)
        {
