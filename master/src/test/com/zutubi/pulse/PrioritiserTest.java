...
public class PrioritiserTest extends PulseTestCase
{
    ...
    public void setUp()
    {
        ...
        buildSpecification = mock(BuildSpecification.class);

        RecipeDispatchRequest request = new RecipeDispatchRequest(buildSpecification, null, null, null, buildResult);
    ...
    public void testAgentNameSignficant()
    {
        ...
        stub(buildSpecification.getName()).toReturn("build spec");
    ...
    {
        verifyDifferentLists("project1", "project2", "buildspec", "buildspec");
    }

    public void testSpecNameSignficant()
    {
        verifyDifferentLists("project", "project", "buildspec1", "buildspec2");
    }

    public void verifyDifferentLists(String projectName1, String projectName2, String buildSpecName1, String buildSpecName2)
    {
        ...
        List<Agent> agentListProject1 = sortList(projectName1, buildSpecName1, agents);
        List<Agent> agentListProject2 = sortList(projectName2, buildSpecName2, agents);

        assertFalse(agentListProject1.equals(agentListProject2));
    }

    private List<Agent> sortList(String projectName1, String buildSpecName1, List<Agent> agents)
    {
        stub(buildSpecification.getName()).toReturn(buildSpecName1);
