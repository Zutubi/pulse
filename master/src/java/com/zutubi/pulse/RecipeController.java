...
public class RecipeController
{
    ...
    {
        buildHookManager.handleEvent(evt, new EventListener()
        {
            public void handleEvent(Event event)
            {
                // simply handles all of the events generated by the build hook processing.
                ((DefaultRecipeLogger)logger).log(event);
            }
